...
describe(component, () => {
  ...
  describe('renders', () => {
    ...
    snap('options renders select dropdown', `<blaze-tags placeholder="Select a tag" options='[{ "text": "Test", "value": "test" }, { "text": "Test Two", "value": "test two" }, { "text": "Test Three", "value": "test three" }]'></blaze-tags>`);
  });
});
