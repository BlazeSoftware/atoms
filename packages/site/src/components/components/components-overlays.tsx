    ...
    return (
      <page-template name={this.name}>
        ...
        <p class="c-paragraph">
          ...
          the <code class="u-code">.c-overlay--visible</code> modifier.
        </p>
        ...
        <p class="c-paragraph">
          ...
          give it the <code class="u-code">.c-overlay--dismissible</code> modifier.
        </p>

        <blaze-demo language="html" classes="modal-demo" code={`<div class="c-overlay c-overlay--visible c-overlay--dismissible"></div>`}/>
        ...
        <p class="c-paragraph">
          ...
          If so use the <code class="u-code">.c-overlay--transparent</code> modifier.
        </p>

        <blaze-demo language="html" classes="modal-demo" code={`<div class="c-overlay c-overlay--visible c-overlay--dismissible c-overlay--transparent"></div>`}/>
        ...
        <p class="c-paragraph">
          You can make overlays cover the entire page by adding the <code class="u-code">.c-overlay--fullpage</code> modifier. The overlay will
