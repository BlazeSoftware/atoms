  ...
  render() {
    return (
      <page-template name={this.name}>
        ...
        <p class="c-paragraph">
          <pre class="u-pre css"><code class="u-code u-code--multiline">{`.u-text { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif; }`}</code></pre>
        </p>
        ...
        <p class="c-paragraph">
          <blaze-demo language="html" code={`<p class="c-paragraph">Use the paragraph class to style your....paragraphs!</p>`} />
        </p>
        ...
        <p class="c-paragraph">
          ...
          the <code class="u-code">.c-link</code> class.
        </p>

        <blaze-demo language="html" code={`<a href="#" class="c-link">.c-link</a><br />
...
<a href="#" class="c-link c-link--error">error</a>`} />
        ...
        <blaze-demo language="html" code={`<span class="u-text--highlight">To highlight text simply wrap the words with the highlight class</span>`} />

        <h3 id="emphasising" class="c-heading u-large">
          Emphasising
        </h3>

        <blaze-demo language="html" code={`<div class="u-text--loud">Sometimes you want to shout</div>
<div class="u-text--quiet">other times you want to whisper</div>`} />
      ...
      <p class="c-paragraph">
        You can highlight <code class="u-code">code</code> within a page by using
        the <code class="u-code">.u-code</code> class.
      </p>

      <p class="c-paragraph">
        Default is inline, to display multi-line snippets add
        the <code class="u-code">.u-code--multiline</code> modifier.
      </p>

      <blaze-demo language="html" demo={false} code={`<code class="u-code u-code--multiline">
  hello
  world
</code>`} />
      ...
      <blaze-demo language="html" code={`<blockquote class="u-blockquote">
