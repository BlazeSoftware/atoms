  ...
  render() {
    return (
      <page-template name={this.name}>
        ...
        <p class="c-paragraph">
          To make a button a Blaze button add the <code class="u-code">.c-button</code> class to
...
<button type="button" class="c-button c-button--error">Button</button>`}/>
        ...
        <blaze-demo language="html" code={`<span class="c-input-group">
  <button type="button" class="c-button c-button--brand">Button</button>
  <button type="button" class="c-button">Button</button>
        ...
        <blaze-demo language="html" code={`<span class="c-input-group c-input-group--rounded">
  <button type="button" class="c-button c-button--brand">Button</button>
  <button type="button" class="c-button">Button</button>
  <button type="button" class="c-button c-button--info">Button</button>
</span>`}/>
        ...
        <blaze-demo language="html" code={`<button type="button" class="c-button u-xsmall">.u-xsmall</button>
...
<button type="button" class="c-button u-super">.u-super</button>`}/>
        ...
        <blaze-demo language="html" code={`<button type="button" class="c-button c-button--block u-xsmall">Button</button>
...
<button type="button" class="c-button c-button--block u-super">Button</button>`}/>
        ...
        <blaze-demo language="html" code={`<button type="button" class="c-button c-button--ghost u-xsmall">Button</button>
...
<button type="button" class="c-button c-button--ghost u-super">Button</button>`}/>
        ...
        <blaze-demo language="html" code={`<button type="button" class="c-button c-button--ghost">Button</button>
...
<button type="button" class="c-button c-button--ghost-error">Button</button>`}/>
        ...
        <blaze-demo language="html" code={`<button type="button" class="c-button c-button--rounded c-button--ghost">Button</button>
