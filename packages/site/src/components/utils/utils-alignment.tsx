...
export class UtilsAlignment {
    ...
    return (
      <page-template name={this.name}>
        ...
        <p class="c-paragraph">
          ...
          <code class="u-code">.u-center-block</code> element some height. If you don't your
          content will appear to only align horizontally.
        </p>

        <h2 id="centered" class="c-heading u-xlarge">Centered</h2>

        <blaze-demo language="html" code={`<div class="u-center-block fixed-height-demo">
  ...
  <div class="u-center-block__content u-center-block__content--vertical">Hello Blaze</div>
    ...
    <div class="u-center-block__content u-center-block__content--horizontal">Hello Blaze</div>
        ...
        <p class="c-paragraph">
          To position an element perfectly in the center of a relative container use the <code class="u-code">.u-absolute-center</code> block.
        </p>
    ...
    <div class="u-absolute-center">Hello Blaze</div>
        ...
        <p class="c-paragraph">
          Use <code class="u-code">.u-centered</code> to apply <code class="u-code">text-align: center;</code> to an element.
        </p>
