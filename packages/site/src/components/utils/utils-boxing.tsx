    ...
    return (
      <page-template name={this.name}>
        ...
        <p class="c-paragraph">
          ...
          the <span class="u-text--loud">top</span> and <span class="u-text--loud">bottom</span> of a given element.
        </p>
        <p class="c-paragraph">
          Available letter box sizes:
        </p>
        <blaze-demo language="css" demo={false} code={`.u-letter-box-super
.u-letter-box-xlarge
.u-letter-box-large
.u-letter-box-medium
.u-letter-box-small
...
.u-letter-box-none`}/>
        ...
        <p class="c-paragraph">
          ...
          the <span class="u-text--loud">left</span> and <span class="u-text--loud">right</span> of a given element.
        </p>
        <p class="c-paragraph">
          Available pillar box sizes:
        </p>
        <blaze-demo language="css" demo={false} code={`.u-pillar-box-super
.u-pillar-box-xlarge
.u-pillar-box-large
.u-pillar-box-medium
.u-pillar-box-small
...
.u-pillar-box-none`}/>
        ...
        <blaze-demo language="css" demo={false} code={`.u-window-box-super
.u-window-box-xlarge
.u-window-box-large
.u-window-box-medium
.u-window-box-small
