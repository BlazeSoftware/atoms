...
export class ObjectsGrid {
  ...
  render() {
    return (
      <page-template name={this.name}>
        ...
        <p class="c-paragraph">
          Use the <code class="u-code">.o-grid</code> class to wrap your <code class="u-code">.o-grid__cell</code> elements.
        </p>

        <blaze-demo language="html" code={`<div class="o-grid o-grid--demo">
  ...
  <div class="o-grid__cell">
    <div class="o-grid-text">third</div>
        ...
        <p class="c-paragraph">
          Use the <code class="u-code">.o-grid__cell--width-xx</code> class to apply widths to your cells. If you add a width to one cell the other cells will automatically take up the rest of the space equally.
        </p>
  ...
  <div class="o-grid__cell">
    <div class="o-grid-text">third</div>
        ...
        <blaze-demo language="html" code={`<div class="o-grid o-grid--full o-grid--demo">
  <div class="o-grid__cell">
    <div class="o-grid-text">first</div>
  </div>
  <div class="o-grid__cell">
  ...
  <div class="o-grid__cell">
    <div class="o-grid-text">third</div>
        ...
        <p class="c-paragraph">
          To "push" a cell horizontally across the grid use the <code class="u-code">.o-grid__cell--offset-xx</code> class. Use in-conjunction with widths to perfectly align your cells.
        </p>
  ...
  <div class="o-grid__cell o-grid__cell--width-66">
    <div class="o-grid-text">second</div>
        ...
        <p class="c-paragraph">
          To solve this we can wrap the cells within the grid by adding the <code class="u-code">.o-grid--wrap</code> modifier class.
        </p>

        <blaze-demo language="html" code={`<div class="o-grid o-grid--wrap o-grid--demo">
  <div class="o-grid__cell o-grid__cell--width-50">
    <div class="o-grid-text">first</div>
  </div>
  <div class="o-grid__cell o-grid__cell--width-66">
  ...
  <div class="o-grid__cell">
    <div class="o-grid-text">fifth</div>
        ...
        <p class="c-paragraph">
          <code class="u-code">.o-grid--top</code>, <code class="u-code">.o-grid--center</code> and <code class="u-code">.o-grid--bottom</code> are supported.
        </p>

        <blaze-demo language="html" code={`<div class="o-grid o-grid--bottom o-grid--demo">
  <div class="o-grid__cell">
    <div class="o-grid-text">first</div>
  </div>
  <div class="o-grid__cell">
  ...
  <div class="o-grid-text">fifth</div>
        ...
        <p class="c-paragraph">
          <code class="u-code">.o-grid__cell--top</code>, <code class="u-code">.o-grid__cell--center</code> and <code class="u-code">.o-grid__cell--bottom</code> are supported.
        </p>
  ...
  <div class="o-grid__cell">
    <div class="o-grid-text">fourth
      ...
      <br/>
        ...
        <blaze-demo language="html" code={`<div class="o-grid o-grid--small-full o-grid--medium-fit o-grid--large-full o-grid--demo">
    <div class="o-grid__cell">
      <div class="o-grid-text">first</div>
    </div>
    <div class="o-grid__cell">
  ...
  <div class="o-grid__cell o-grid__cell--width-100 o-grid__cell--width-33@large">
    <div class="o-grid-text">large</div>
        ...
        <p class="c-paragraph">
          The suffixes apply to the screen sizes <em class="u-text--loud">and up</em>, in a mobile first manner. In other words:
        </p>
        ...
        <p class="c-paragraph">
          Sometimes you want your cells to be flush with each other. To turn off all gutters use <code class="u-code">.o-grid--no-gutter</code>
        </p>

        <blaze-demo language="html" code={`<div class="o-grid o-grid--no-gutter o-grid--demo">
  <div class="o-grid__cell">
    <div class="o-grid-text">first</div>
  </div>
  <div class="o-grid__cell">
  ...
  <div class="o-grid__cell o-grid__cell--no-gutter">
    <div class="o-grid-text">third</div>
        ...
        <p class="c-paragraph">
          Usually cells in a grid will be <em class="u-text--loud">fluid and responsive</em>. If however you want to set a cell to a fixed width add the <code class="u-code">.o-grid__cell--width-fixed</code> modifier and give it a specific width.
        </p>
